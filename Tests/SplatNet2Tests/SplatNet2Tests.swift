...
final class SplatNetTests: XCTestCase {
    ...
    func testCookieForSP2() async throws {
        ...
        let splatoonToken: GameServiceToken.Response = try await session.getGameServiceToken(accessToken: accessToken, version: version)
        ...
        let splatoonAccessToken: GameWebToken.Response = try await session.getGameWebToken(accessToken: splatoonToken, version: version)
