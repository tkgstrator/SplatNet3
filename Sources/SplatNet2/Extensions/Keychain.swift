...
public extension Keychain {
    ...
    func set(_ account: UserInfo) throws {
        try set(try account.asData(), key: "SPLATNET2_ACCOUNTS")
    }

    /// アカウント上書き
    func set(_ accounts: [UserInfo]) throws {
        try set(try accounts.asData(), key: "SPLATNET2_ACCOUNTS")
    }
    ...
    func get() -> [UserInfo] {
        ...
        guard let data: Data = try? getData("SPLATNET2_ACCOUNTS") else {
            return []
        }
